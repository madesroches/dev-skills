...
argument-hint: ""
allowed-tools: Bash(git *), Bash(gh *), Bash(mv *), Bash(mkdir *), Bash(ls *), Read, Glob, Grep, Edit, Write, Task, AskUserQuestion
---
...
3. `git diff main..HEAD --stat` — file summary to determine which areas changed
...
2. From `git diff main..HEAD --stat`, determine which areas of the codebase changed
